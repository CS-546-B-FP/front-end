...
const SCRIPTS = ['/public/js/form-validation.js', '/public/js/loading-form.js', '/public/js/dialog.js', '/public/js/watchlist.js', '/public/js/ajax-form.js', '/public/js/shortlist-note.js', '/public/js/app.js'];
